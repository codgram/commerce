...
using Commerce.Shared.Models.Organization;
...
namespace Commerce.Server.Controllers.Organization
{
    ...
    public class MembersController : ControllerBase
    {
        ...
        public MembersController(CommerceContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Member.Where(c => c.CompanyId == companyId).ToListAsync();
        }
